...
<html xmlns="http://www.w3.org/1999/xhtml" dir="<?php bloginfo('text_direction'); ?>" xml:lang="<?php bloginfo('language'); ?>">
    <head>
        ...
        <link href='http://fonts.googleapis.com/css?family=Abril+Fatface|Prata' rel='stylesheet' type='text/css'>
	...
	<body <?php if ( is_home() ) : echo 'class="home"'; endif;?>>
        <div class="wrapper">
            <div class="header clear">
                <h1><a href="<?php bloginfo('home'); ?>">A thousand free words <br /><span>(or less)</span></a></h1>
